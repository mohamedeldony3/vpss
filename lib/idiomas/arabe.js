...
const smsLista1 = () => { return `🌟 معلومات Zenon 🌟`}
...
const smsLista7 = () => { return `🐈 تثبيت Zenon 🐈`}
...
const smsModP2 = () => { return `تمكين الوظيفة حتى يتمكن الجميع من استخدام Zenon`}
const smsModAd1 = () => { return `🛂 وضع المشرف`}
const smsModAd2 = () => { return `سيتمكن المسؤولون فقط من استخدام Zenon في المجموعات`}
...
const smsJBInfo2 = () => { return `💖 *الوظيفة مستقرة ، إذا واجهت أي إزعاج ، فاتصل بالبريد: centerZenon@gmail.com*\n💝 *يمكنك تقديم تبرع طوعي عن طريق PayPal: ${global.paypal}*\n\n*شكرا جزيلا على الدعم ${global.packname}*`}
...
const smsContacto4 = () => { return 'جهة اتصال Zenon الرسمية 🐈'}
