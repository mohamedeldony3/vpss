...
const smsLista1 = () => { return `🌟 INFORMASI Zenon 🌟`}
...
const smsLista7 = () => { return `🐈 PASANG Zenon 🐈`}
...
const smsModP2 = () => { return `Aktifkan fungsi agar semua orang dapat menggunakan Zenon`}
const smsModAd1 = () => { return `🛂 MODE ADMIN`}
const smsModAd2 = () => { return `Hanya Admin yang dapat menggunakan Zenon di Grup`}
...
const smsContacto4 = () => { return 'Kontak Resmi Zenon 🐈'}
