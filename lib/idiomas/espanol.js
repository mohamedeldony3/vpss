...
const smsLista1 = () => { return `🌟 INFORMACIÓN DE Zenon 🌟`}
...
const smsLista7 = () => { return `🐈 INSTALAR Zenon 🐈`}
...
//_allantilink.js
const smsTextoYT = () => { return '😻 𝗦𝘂𝗽𝗲𝗿 Zennon - 𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽 '} 
...
const smsModP2 = () => { return `Habilitar función para que todos puedan usar Zenon`}
const smsModAd1 = () => { return `🛂 MODO ADMIN`}
const smsModAd2 = () => { return `Solo los Admins podrán usar Zenon en Grupos`}
...
const smsJBInfo2 = () => { return `💖 *La función es estable, sí presenta algún inconveniente Comuníquese al correo: centerZenon@gmail.com*\n💝 *Puede hacer una Donación voluntaria por PayPal: ${global.paypal}*\n\n*Muchas Gracias por el apoyo a ${global.packname}*`}
...
const smsContacto4 = () => { return 'Contacto Oficial de Zenon 🐈'}
