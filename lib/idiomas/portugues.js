...
const smsLista1 = () => { return `🌟 INFORMAÇÕES DO Zenon 🌟`}
...
const smsLista7 = () => { return `🐈 INSTALAR O Zenon 🐈`}
...
const smsModP2 = () => { return `Ativar função para que todos possam usar o Zenon`}
const smsModAd1 = () => { return `🛂 MODO ADMINISTRADOR`}
const smsModAd2 = () => { return `Apenas Admins poderão usar o Zenon em Grupos`}
...
const smsJBInfo2 = () => { return `💖 *A função é estável, se apresentar algum inconveniente Entre em contato com o e-mail: centerZenon@gmail.com*\n💝 *Você pode fazer uma doação voluntária pelo PayPal: ${global.paypal}*\n\n*Muito obrigado pelo apoio ${global.packname}*`}
...
const smsContacto4 = () => { return 'Contato Oficial Zenon 🐈'}
